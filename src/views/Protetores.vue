...
<template>
  <div id="animais" class="rounded-lg m-10 px-12">
    ...
    <h1 class="font-medium leading-tight text-5xl mt-0 mb-2 ">Protetores</h1>
    ...
    <ul class="divide-y divide-gray-100">
      <li class="px-4 pt-4 mt-3 text-2xl text-center">
        ...
        v-for="protetor in protetores" :key="protetor">
            <div class="flex justify-center">
                <div class="w-2/3 m-2">{{protetor.nome}}</div>
                <div class="w-2/3 m-2">{{protetor.salario}}</div>
